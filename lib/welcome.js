...
async function handleWelcome(sock, chatId, message, match) {
    ...
    if (lowerCommand === 'on') {
        ...
        return sock.sendMessage(chatId, { text: '✅ Welcome messages *enabled* with beautiful default format. Use *.welcome set [your message]* to customize.', quoted: message });
    }
...
async function handleGoodbye(sock, chatId, message, match) {
    ...
    if (lower === 'on') {
        ...
        return sock.sendMessage(chatId, { text: '✅ Goodbye messages *enabled* with beautiful default format. Use *.goodbye set [your message]* to customize.', quoted: message });
    }
