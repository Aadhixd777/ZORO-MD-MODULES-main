...
‎┃
‎┃👑╔◉${transformText('Owner')} : ${transformText('Aadhi Xd')}
...
‎© *${transformText('POWERED BY XD BROTHERS AADHIXD X ROMEOXD')}*`;
    ...
    const imgUrl = "https://i.imgur.com/W2o4s5T.png";
    ...
    // ContextInfo fixed for working Instagram Link & Clean Preview
    const contextInfo = {
        externalAdReply: {
            title: "ZORO MD OFFICIAL BOT",
            body: "𝗭𝗢𝗥𝗢 𝗕𝗬 𝗔𝗮𝗱𝗵𝗶𝘅𝗱",
            showAdAttribution: true,
            renderLargerThumbnail: false, // ബ്ലാക്ക് ബോക്സ് ഒഴിവാക്കാൻ false ആക്കി
            thumbnail: thumbBuffer,
            thumbnailUrl: imgUrl, // ഇമേജ് കൃത്യമായി തെളിയാൻ നൽകി
            mediaType: 1,
            sourceUrl: "https://www.instagram.com/aadhi.x._______________" // ഡയറക്റ്റ് ഇൻസ്റ്റഗ്രാം റീഡയറക്ഷൻ ലിങ്ക്
        }
    };
