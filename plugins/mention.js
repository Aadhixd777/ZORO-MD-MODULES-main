...
function loadState() {
    try {
        ...
        // Ensure our custom URLs are always present
    ...
    try {
        ...
        if (audioBuffer) {
            try {
                ...
                console.log(`✅ Mention audio sent`);
                return;
        ...
        try { await sock.sendMessage(chatId, { text: '👋 Hey! Mentioned me?' }, { quoted: message }); } catch {}
    }
}
