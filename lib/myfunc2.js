...
exports.WAVersion = async () => {
    ...
    let version = [get?.currentVersion ? get.currentVersion.replace(/[.]/g, ", ") : "2.2409.2"]
    return version
}
...
exports.buffergif = async (image) => {
	...
	await fs.promises.writeFile(`./XeonMedia/trash/${filename}.gif`, image)
	child_process.exec(
	...
	Promise.all([unlink(`./XeonMedia/trash/${filename}.mp4`).catch(() => {}), unlink(`./XeonMedia/trash/${filename}.gif`).catch(() => {})])
	return buffer5
}
