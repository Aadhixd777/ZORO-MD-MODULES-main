...
const CUSTOM_AUDIO_URLS = [
    "https://h.uguu.se/ugdMXtZi.mp3",
    "https://n.uguu.se/ZyJwnSDk.mp3"
];
...
// 🎯 നിങ്ങളുടെ GitHub-ലെ തംബ്നൈൽ ചിത്രത്തിന്റെ Direct Raw Link
const GITHUB_THUMB_URL = "https://raw.githubusercontent.com/Aadhixd777/ZORO-MD-MODULES-main/main/media/custom_thumb.jpg";
...
async function handleMentionDetection(sock, chatId, message) {
    try {
        ...
        // 🎯 LARGE THUMBNAIL + INSTAGRAM REDIRECT CONTEXT
        const adReplyContext = {
            externalAdReply: {
                title: "ZORO MD OFFICIAL",
                body: "Click to visit Instagram Profile",
                showAdAttribution: true,
                renderLargerThumbnail: true, // 🎯 വലിയ കാർഡ് പ്രിവ്യൂ
                thumbnail: thumbBuffer || undefined,
                thumbnailUrl: GITHUB_THUMB_URL, // 🎯 ചിത്രത്തിന്റെ GitHub Raw Link
                mediaType: 1, // 🎯 Large Image Card കാണിക്കാൻ 1
        ...
        if (audioBuffer) {
            try {
                // 🎯 Voice Note വരാതെ സാധാ MP3 ആയി പോകുന്ന രീതിയിൽ മാറ്റിയത്
