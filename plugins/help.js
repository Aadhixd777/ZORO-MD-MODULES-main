...
‎© *${transformText('POWERED BY XD BROTHERS AADHIXD X ROMEOXD')}*`;
    ...
    // Local media/thumb.jpg ഫയൽ റീഡ് ചെയ്ത് Buffer ആക്കുന്നു
    ...
    if (fs.existsSync(thumbPath)) {
        ...
        console.error('Thumbnail image not found at:', thumbPath);
    }

    // Fix: thumbnailUrl ഒഴിവാക്കി direct local thumbnail ബഫർ മാത്രം നൽകുന്നു
    const contextInfo = {
        externalAdReply: {
