...
‎© *${transformText('POWERED BY XD BROTHERS AADHIXD X ROMEOXD')}*`;
    ...
    // Fetch Thumbnail Buffer dynamically
    ...
    // ContextInfo configured for Verified Ad Banner
    const contextInfo = {
        externalAdReply: {
            title: "ZORO MD OFFICIAL BOT",
            body: "𝗭𝗢𝗥𝗢 𝗕𝗬 𝗔𝗮d𝗵𝗶𝘅𝗱",
            showAdAttribution: true,
            renderLargerThumbnail: true, // Verified badge and thumbnail proper layout-in kanikan true aakki
